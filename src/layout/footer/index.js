        ...
        <div id="office-hours" className="office-hours">
          ...
          <p>
            <a
              ...
              className="demo-cta cta docs-cta"
            >
              Learn Pantheon
            </a>{" "}
            <a
                    ...
                    <div className="col-xs-6 col-sm-3">
                      ...
                      <ul className="menu">
                        <li className="first leaf menu-mlid-1151">
                          <a
                            href="https://pantheon.io/contact-us"
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="copyright">
                        ...
                        <span>|</span> 717 California Street, San Francisco, CA{" "}
                        <span className="responsive-pipe">|</span>{" "}
                        <a
                          className="new-line"
                        ...
                        <div className="row">
                          <div className="col-lg-12 col-sm-6">
                            ...
                            <p>
                              ...
                              Plus get 3 free downloads, just for signing up. If
                              you don't love it, unsubscribe with just a click.
                            </p>
                          </div>
